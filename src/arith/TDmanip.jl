...
copysign(a::TD,b::TD) = TD(copysign(a.hi,b.hi), copysign(a.md,b.hi), copysign(a.lo,b.hi))
flipsign(a::TD,b::TD) = TD(flipsign(a.hi,b.hi), flipsign(a.md,b.hi), flipsign(a.lo,b.hi))
copysign(a::TD,b::Float64) = TD(copysign(a.hi,b), copysign(a.md,b), copysign(a.lo,b))
flipsign(a::TD,b::Float64) = TD(flipsign(a.hi,b), flipsign(a.md,b), flipsign(a.lo,b))
copysign(a::TD,b::Integer) = TD(copysign(a.hi,b), copysign(a.md,b), copysign(a.lo,b))
flipsign(a::TD,b::Integer) = TD(flipsign(a.hi,b), flipsign(a.md,b), flipsign(a.lo,b))
